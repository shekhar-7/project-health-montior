...
import { validateConfigs } from "./config/external-services.config";

// Validate external service configurations
if (!validateConfigs()) {
  console.error(
    "External service configurations are invalid. Please check your environment variables."
  );
  process.exit(1);
}
...
app.get("/debug", (req, res) => {
  res.json({
    swagger: {
      loaded: !!swaggerSpec,
      routesCount: (swaggerSpec as any)?.paths
